...
const Content = ({ superList, dedupe, showMessage, containerContents }) => {
  ...
  return (
    <div className='content'>
      {containerContents.map((containerContent, i) => (<Container key={'container' + containerContent.id} icon={iconLocations[i % 3]} heading={containerContent.title} text={containerContent.content} />))}
